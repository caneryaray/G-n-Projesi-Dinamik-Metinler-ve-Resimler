...
topContenth4s[0].textContent = siteContent['top-content']['left-h4'];
topContenth4s[1].textContent = siteContent['top-content']['right-h4'];

const topContentPs = document.querySelectorAll('.top-content P');

topContentPs[0].textContent = siteContent['top-content']['left-content'];
topContentPs[1].textContent = siteContent['top-content']['right-content'];
...
bottomcontenth4s[0].textContent = siteContent['bottom-content']['left-h4'];
bottomcontenth4s[1].textContent = siteContent['bottom-content']['middle-h4'];
bottomcontenth4s[2].textContent = siteContent['bottom-content']['right-h4'];

const bottomcontentPs = document.querySelectorAll('.bottom-content P');

bottomcontentPs[0].textContent = siteContent['bottom-content']['left-content'];
bottomcontentPs[1].textContent =
  siteContent['bottom-content']['middle-content'];
bottomcontentPs[2].textContent = siteContent['bottom-content']['right-content'];
